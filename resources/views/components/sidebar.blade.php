    ...
    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
        ...
        @if (auth()->user()->hasRole('admin'))
            <li class="nav-item has-submenu">
                <a class="nav-link submenu-toggle {{ request()->segment(1) == 'user' ? 'active' : '' }}" href="#"
                    data-bs-toggle="collapse" data-bs-target="#submenu-1" aria-expanded="false"
                ...
                <div id="submenu-1"
                    class="collapse submenu submenu-1 {{ request()->segment(1) == 'user' ? 'show' : '' }}"
                    data-bs-parent="#menu-accordion">
                    <ul class="submenu-list list-unstyled">
                        <li class="submenu-item">
                            <a class="submenu-link {{ request()->segment(1) == 'user' ? 'active' : '' }}"
                                href="{{ route('user') }}">Kelola User</a>
                        </li>
                    </ul>
                </div>
            </li>
...
<div class="app-sidepanel-footer">
    <nav class="app-nav app-nav-footer">
        <ul class="app-menu footer-menu list-unstyled">
            ...
            <li class="nav-item">
                <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                <a class="nav-link" href="https://github.com/abdarjavaindo/laravel_starter_kit" target="blank">
                    {{-- icon --}}
                    <span class="nav-icon">
